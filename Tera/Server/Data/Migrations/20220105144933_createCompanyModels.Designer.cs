...
namespace Tera.Server.Data.Migrations
{
    ...
    [Migration("20220105144933_createCompanyModels")]
    partial class createCompanyModels
    {
            ...
            modelBuilder.Entity("Tera.Shared.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CompanyId = new Guid("1450b96b-b478-4101-9b93-d7b988b90e2d"),
                        ...
                        new
                        {
                            CompanyId = new Guid("ce550104-8536-499f-a011-f2882b1cc795"),
                        ...
                        new
                        {
                            CompanyId = new Guid("976b949d-7a17-4060-bddc-a5ed68b84ddd"),
                            DateCreated = new DateTime(2018, 6, 12, 2, 0, 0, 0, DateTimeKind.Unspecified),
